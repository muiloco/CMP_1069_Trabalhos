...
public class Tela extends javax.swing.JFrame {
     ...
     */
    Moedas dolar = new Moedas("EUA", (float)3.88);
    Moedas euro = new Moedas("UE", (float)4.40);
    Moedas iene = new Moedas("JAP", (float)0.034);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Valor em Dolar $:");

        jLabel3.setText("Valor em Euro €:");

        jLabel4.setText("Valor em Iene ¥:");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(jTextFieldEuro)
                                        .addComponent(jTextFieldDolar)
                                        .addComponent(jTextFieldIene, javax.swing.GroupLayout.DEFAULT_SIZE, 70, Short.MAX_VALUE))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       float valorReal = Float.parseFloat(jTextFieldReal.getText());
        jTextFieldDolar.setText(df.format(dolar.converterMoeda(valorReal)));
        jTextFieldEuro.setText(df.format(euro.converterMoeda(valorReal)));
        jTextFieldIene.setText(df.format(iene.converterMoeda(valorReal)));
